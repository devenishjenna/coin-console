      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          <div className="border rounded-lg p-4">
            ...
            <p className="text-2xl font-semibold">{formatCurrency(coin.current_price)}</p>
          </div>
          <div className="border rounded-lg p-4">
            <p className="text-sm uppercase text-gray-500 mb-2">Low 24h</p>
            <p className="text-2xl font-semibold">{formatCurrency(coin.low_24h)}</p>
          </div>
          <div className="border rounded-lg p-4">
            <p className="text-sm uppercase text-gray-500 mb-2">High 24h</p>
            <p className="text-2xl font-semibold">{formatCurrency(coin.high_24h)}</p>
          </div>
